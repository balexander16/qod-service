...
public class GoogleTokenServices implements ResourceServerTokenServices {
  ...
  public OAuth2Authentication loadAuthentication(String accessToken)
    ...
    try {
      ...
      if (idToken != null) {
        Payload payload = idToken.getPayload();  // Payload may contain more useful information then we are using.
        // TODO check user registry if any to see what role should be granted.
